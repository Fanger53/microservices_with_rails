...
Rails.application.configure do
  ...
  config.x.circuit_breaker.failure_threshold = 5
  config.x.circuit_breaker.timeout = 10.seconds
  config.x.circuit_breaker.recovery_timeout = 30.seconds
  
  # Rate limiting in production
  config.x.rate_limiting.enabled = true
  config.x.rate_limiting.requests_per_minute = 100
